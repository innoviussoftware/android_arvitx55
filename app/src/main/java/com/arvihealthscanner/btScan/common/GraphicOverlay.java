...
public class GraphicOverlay extends View {
  ...
  public static  float widthScaleFactor = 1.0f;
  public static int previewHeight;
  public static float heightScaleFactor = 1.0f;
    ...
    try {
      synchronized (lock) {
        if ((previewWidth != 0) && (previewHeight != 0)) {
          ...
          // Log.d("TEST","widthScaleFactor:"+widthScaleFactor+" heightScaleFactor:"+heightScaleFactor+"getWidth() :"+getWidth()+"getHeight()"+getHeight()+"previewWidth:"+previewWidth+"previewHeight:"+previewHeight);
          // Log.d("CANVAS ","HEIGHT:"+canvas.getHeight()+"WIDTH "+canvas.getWidth());
